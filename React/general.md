...
### 8. Что такое менеджер состояний?
...
### 9. Что такое пробрасывание пропсов (props drilling)?

Под пробрасыванием («сверлением») пропсов / реквизитов понимается процесс передачи пропсов / реквизитов через несколько уровней вложенных компонентов, даже если некоторые промежуточные компоненты не используют эти пропсы напрямую. Глубокое пробрасывание делает структуру кода сложной и запутанной.
...
### 10. Как работает условный рендеринг элементов?

С помощью условных операторов, в том числе тернарных, можно по разному отрисовывать элементы.
...
### 11. В чем разница между useMemo и useCallback?
...
Фрагменты React позволяют группировать несколько элементов внутри функции-компонента, избегая таким образом создания большого количества узлов в виртуальном DOM.
...
### 13. Что такое пользовательский хук?
...
[Примеры кастомного хука](/React/otherExamples/customHooks.md)

### 14. Правила создания пользовательского хука
